...
def _save_workflow_analysis_markdown(
    ...
    """Save minimal workflow analysis report."""
    summary = _create_workflow_analysis_summary(analysis_data)
    overview = summary["workflow_overview"]

    markdown = f"""# Analysis: {overview['total_processors']} processors, {overview['actual_data_processors']} contain business logic

**Migration Focus:** {overview['actual_data_processors']} data processors out of {overview['total_processors']} total
"""
